...
<body>
    <div class="cover">
	<img src="http://eccles.utah.edu/wp-content/themes/wptheme-avada5/logos/eccles_logo_footer.png" />
        <h1>Resource not found <small>Error 404</small></h1>
        <p class="lead">Oops! It looks like the page you are looking is no longer here.</p>
	<p class="lead">If you feel something <strong>should</strong> be here, please contact the David Eccles School of Business ITG Helpdesk @ 801-581-3403.</p>
    </div>
